...
class OrderBookConsole(OrderBook):
    ...
    def __init__(self, product_id=None, keys=None):
        ...
        self.sell_initial_offset = 40
        self.buy_additional_offset = 2
        self.sell_additional_offset = 5
        self.bid_theo = 0
        self.ask_theo = 0
        self.net_position = 0
        self.buy_levels = 0
            ...
            if self.valid_sma:
                ...
                if self.net_position == 0:
                    ...
                    if self.net_position > 2:
                        self.bid_theo = self.sma - (self.buy_initial_offset * abs(self.net_position)) - (self.buy_additional_offset * (self.net_position * self.net_position))
                        self.ask_theo = self.sma - (self.buy_initial_offset * abs(self.net_position) * 0.5) - (self.buy_additional_offset * ((self.net_position - 2) * (self.net_position - 2)))
                    ...
                    # We are short
                    if self.net_position < -2:
                        self.ask_theo = self.sma + (self.sell_initial_offset * abs(self.net_position)) + (self.sell_additional_offset * (self.net_position * self.net_position))
                        self.bid_theo = self.sma + (self.sell_initial_offset * abs(self.net_position) * 0.5) + (self.sell_additional_offset * ((self.net_position + 2) * (self.net_position + 2)))
