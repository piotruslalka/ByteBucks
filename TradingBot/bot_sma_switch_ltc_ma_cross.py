...
strategy_settings = {
    'product_id': 'LTC-USD',
    'min_tick': 0.1,
    'strategy_name': "bot_ltc_cross_stable",
    'order_size': 0.1,
    'set_ma_value': True,
    ...
    'sma_cross_diff': 0,
    'break_out_level_add': 5,
    'break_out_level_reduce': 5,
...
#order_book.auth_client.buy_levels = 1.071
#order_book.auth_client.net_position = 7
...
while order_book.message_count < 1000000000000:
    ...
    if strategy_settings.get('set_ma_value') == True:
        base_sma = my_MA.add_value(order_book.trade_price)
