...
strategy_settings = {
    'product_id': 'BTC-USD',
    'min_tick': round(0.001, 3),
    'strategy_name': "bot_btc_goWith",
    'order_size': 0.001,
    'set_ma_value': False,
    ...
    'buy_max_initial_profit_target': 1000000,
    'sell_max_initial_profit_target': 1000000,
    'max_long_position': 1000000,
    'max_short_position': 1000000,
    'sma_swap_trigger_level': 1000000,
    'sma_long_duration': 4*60,
    'sma_trading_duration': 5,
    'sma_cross_short_duration': 15,
    'sma_cross_long_duration': 60,
...
while order_book.message_count < 1000000000000:
    ...
    if long_sma != None:
        if my_MA.count > 30 and order_book.trade_price != None:
            ...
            sma_trading_duration = my_MA.get_sma(strategy_settings.get('sma_trading_duration')*60)

            order_book.sma_cross_short = sma_cross_short
            order_book.sma_cross_long = sma_cross_long
            order_book.sma = sma_trading_duration
